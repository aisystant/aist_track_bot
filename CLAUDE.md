...
| **Урок** | Теория в Марафоне (текст + вопрос) |
...
| Тип | Подтип | Описание |
|-----|--------|----------|
| **Текст** | Текст урока | Теоретический материал (Марафон) |
| **Текст** | Текст задания | Инструкция к практике (Марафон) |
| **Текст** | Дайджест | Ежедневный материал (Лента) |
...
1. Определи, к какому основному типу относится (Текст, Вопрос, Обратная связь и т.д.)
