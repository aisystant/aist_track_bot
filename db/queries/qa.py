...
async def save_qa(pool, chat_id: int, mode: str, context_topic: str,
...
async def get_qa_history(pool, chat_id: int, limit: int = 50) -> List[dict]:
...
async def get_qa_count(pool, chat_id: int) -> int:
