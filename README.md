...
- **Онбординг** — бот узнаёт о стажере: область работы, интересы, проблемы, желания, цели
- **Персонализация** — контент адаптируется под профиль, проблемы и желания стажера
- **Обновление профиля** — возможность регулярно обновлять свои проблемы и желания
...
```
1. /start → Онбординг (имя, область, интересы, проблемы, желания, цели)
...
5. Тема засчитана ✅
6. /update → Обновляй проблемы и желания для лучшей персонализации
7. Повторить со следующей темой
```
