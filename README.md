...
- **Таксономия Блума** — автоматическое повышение сложности вопросов
...
| `/update` | Обновить ценности, цели, уровень сложности |
...
7. /update → Обновляй ценности и цели для лучшей персонализации
```
